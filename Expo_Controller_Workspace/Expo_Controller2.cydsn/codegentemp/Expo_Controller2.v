...
module CharLCD_v2_10_2 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("462a3021-e855-46af-9124-643a67243391/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module ADC_SAR_SEQ_P4_v2_20_4 (
	...
	cy_clock_v1_0
		#(.id("3959c855-20f4-4909-aa67-2868f90be9e0/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("625000000"),
		  .is_direct(0),
...
module top ;
	...
	cy_clock_v1_0
		#(.id("7990b9b8-2357-4ac6-a1a0-b12f51bc089f"),
	...
	wire [0:0] tmpOE__PWM_Contrast_net;
	wire [0:0] tmpFB_0__PWM_Contrast_net;
	wire [0:0] tmpIO_0__PWM_Contrast_net;
	wire [0:0] tmpINTERRUPT_0__PWM_Contrast_net;
	electrical [0:0] tmpSIOVREF__PWM_Contrast_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		PWM_Contrast
		 (.oe(tmpOE__PWM_Contrast_net),
		  .y({Net_184}),
		  .fb({tmpFB_0__PWM_Contrast_net[0:0]}),
		  .io({tmpIO_0__PWM_Contrast_net[0:0]}),
		  .siovref(tmpSIOVREF__PWM_Contrast_net),
		  .interrupt({tmpINTERRUPT_0__PWM_Contrast_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PWM_Contrast_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PWM_LCD_Led_net;
	wire [0:0] tmpFB_0__PWM_LCD_Led_net;
	wire [0:0] tmpIO_0__PWM_LCD_Led_net;
	wire [0:0] tmpINTERRUPT_0__PWM_LCD_Led_net;
	electrical [0:0] tmpSIOVREF__PWM_LCD_Led_net;

	cy_psoc3_pins_v1_10
		#(.id("60c07920-c9da-452f-a137-8502e00e3809"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PWM_LCD_Led
		 (.oe(tmpOE__PWM_LCD_Led_net),
		  .y({Net_214}),
		  .fb({tmpFB_0__PWM_LCD_Led_net[0:0]}),
		  .io({tmpIO_0__PWM_LCD_Led_net[0:0]}),
		  .siovref(tmpSIOVREF__PWM_LCD_Led_net),
		  .interrupt({tmpINTERRUPT_0__PWM_LCD_Led_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PWM_LCD_Led_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__ADC_12V_net;
	wire [0:0] tmpFB_0__ADC_12V_net;
	wire [0:0] tmpIO_0__ADC_12V_net;
	wire [0:0] tmpINTERRUPT_0__ADC_12V_net;
	electrical [0:0] tmpSIOVREF__ADC_12V_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		ADC_12V
		 (.oe(tmpOE__ADC_12V_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ADC_12V_net[0:0]}),
		  .analog({Net_935}),
		  .io({tmpIO_0__ADC_12V_net[0:0]}),
		  .siovref(tmpSIOVREF__ADC_12V_net),
		  .interrupt({tmpINTERRUPT_0__ADC_12V_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ADC_12V_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__ADC_3V_net;
	wire [0:0] tmpFB_0__ADC_3V_net;
	wire [0:0] tmpIO_0__ADC_3V_net;
	wire [0:0] tmpINTERRUPT_0__ADC_3V_net;
	electrical [0:0] tmpSIOVREF__ADC_3V_net;

	cy_psoc3_pins_v1_10
		#(.id("0b6be96f-8d75-4fb9-ac3e-f069a4cef8dc"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		ADC_3V
		 (.oe(tmpOE__ADC_3V_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ADC_3V_net[0:0]}),
		  .analog({Net_1345}),
		  .io({tmpIO_0__ADC_3V_net[0:0]}),
		  .siovref(tmpSIOVREF__ADC_3V_net),
		  .interrupt({tmpINTERRUPT_0__ADC_3V_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ADC_3V_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Led_Strobe_net;
	wire [0:0] tmpFB_0__Led_Strobe_net;
	wire [0:0] tmpIO_0__Led_Strobe_net;
	wire [0:0] tmpINTERRUPT_0__Led_Strobe_net;
	electrical [0:0] tmpSIOVREF__Led_Strobe_net;

	cy_psoc3_pins_v1_10
		#(.id("fac4ccbd-ddc5-419f-818d-c525d011b4ac"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Led_Strobe
		 (.oe(tmpOE__Led_Strobe_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Led_Strobe_net[0:0]}),
		  .io({tmpIO_0__Led_Strobe_net[0:0]}),
		  .siovref(tmpSIOVREF__Led_Strobe_net),
		  .interrupt({tmpINTERRUPT_0__Led_Strobe_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Led_Strobe_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("02eeb064-af03-43a9-bd85-325a0d1d5279"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("42f20b93-8c7e-4053-beec-3901c4c02c02"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__Bootloader_En_net;
	wire [0:0] tmpFB_0__Bootloader_En_net;
	wire [0:0] tmpIO_0__Bootloader_En_net;
	wire [0:0] tmpINTERRUPT_0__Bootloader_En_net;
	electrical [0:0] tmpSIOVREF__Bootloader_En_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		Bootloader_En
		 (.oe(tmpOE__Bootloader_En_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Bootloader_En_net[0:0]}),
		  .io({tmpIO_0__Bootloader_En_net[0:0]}),
		  .siovref(tmpSIOVREF__Bootloader_En_net),
		  .interrupt({tmpINTERRUPT_0__Bootloader_En_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Bootloader_En_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
